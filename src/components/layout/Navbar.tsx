      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link
              href="/find"
              className="hidden sm:inline-flex items-center justify-center gap-1.5 px-4 py-2 text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-navy-800 to-navy-900 hover:from-navy-700 hover:to-navy-800 rounded-xl shadow-sm hover:shadow transition-all transform active:scale-95"
            >
